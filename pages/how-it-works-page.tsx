...
export const getStaticProps = async () => {
  ...
  const plasmicData = await PLASMIC.fetchComponentData('/how-it-works-page');
  if (!plasmicData) {
...
export default function HowItWorks(props: { plasmicData: ComponentRenderData; queryCache?: Record<string, AnyRecord> }) {
